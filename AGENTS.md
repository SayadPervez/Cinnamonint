...
| 2 | `src/learn/learner.py` | Learn mode orchestration |
| 3 | `src/learn/prompts.py` | LLM prompt templates |
| 4 | `src/learn/generator.py` | Code generation interface (editor-based or API) |
| 5 | `src/learn/tester.py` | Test runner for generated handlers |
| 6 | Port legacy handlers | Manually write handlers for all legacy CLINT commands first, validating the learn flow |
